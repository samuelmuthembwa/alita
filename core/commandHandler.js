const { handleBets } = require("../functions/bestBets");
  ...
  if (resolve.isGroup) {
    ...
    if (bannedUsers.includes(userId)) {
      sock.sendMessage(
        m.key.remoteJid,
        {
          text: "❌ You were banned from using AlitaBot. Sorry contact bot owner.",
        },
        { quoted: m }
      );
    } else {
      switch (resolve.command) {
        ...
        //       sock.sendMessage(
        //         m.key.remoteJid,
        //         { text: "⛔ Bot owner command." },
        //         { quoted: m }
        //       );
        //     } else {
        //       handleBan(sock, resolve, m);
        //     }
        //     break;
        //   case "unban":
        ...
        //       let msg =
        //         "❌ You used this command today, wait until tommorow or contact bot owner.";
        //       sock.sendMessage(
        //         resolve.sender,
        //         { text: msg },
        //         { quoted: m }
        ...
        default:
          sock.sendMessage(resolve.sender, { text: "🧐 Unrecognized command. Type *.help* to views all commands." }, { quoted: m });
          break;
      }
    }
  }
